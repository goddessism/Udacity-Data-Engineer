...
songplay_table_create = ("CREATE TABLE songplays (songplay_id  serial PRIMARY KEY, start_time time, user_id int, level varchar,  \
                         song_id varchar,\
...
song_table_create = ("CREATE TABLE songs (song_id varchar, title varchar, artist_id varchar, year int, duration numeric)")

artist_table_create = ("CREATE TABLE artists (artist_id varchar, name varchar, location varchar, latitude numeric, longitude numeric)")
